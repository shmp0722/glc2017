...
# -*- coding: utf-8 -*-
"""
Created on Mon Sep 18 16:40:36 2017
...
#import csv
#fieldnames = csv.reader(df)
#i = fieldnames.

df.to_excel('df_20170918_Turpin.xlsx')


df = pd.read_excel(os.path.join(os.getcwd(),'df_20170918_Turpin.xlsx'))
...
DF = pd.read_excel(os.path.join(os.getcwd(),'Normal_CSFI10-2data-2.xlsx'))
...
DF.to_excel('norm_20170918_Turpin.xlsx')
